...
We tested the Metropolis-Hastings algorithm using 2 periods of the VIX, shown in the top panel of Fig. 8. The MH algorithm performs well in estimating the market volatility using the hierarchical Bayesian model. 
